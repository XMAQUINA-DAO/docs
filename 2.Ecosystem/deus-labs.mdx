...
<Columns cols={3}>
  <Card title="DEUS Creator Program" icon="video" href="/deus-labs/program" cta="Participate">
    The creator program for **creating content** that shapes the XMAQUINA brand narrative
  </Card>
  <Card title="Robonoid" icon="newspaper" href="/deus-labs/robonoid" cta="Learn more">
    A news and media platform, fully focused on **informing** the world about humanoids
  </Card>
  <Card title="Mech Merch" icon="bag-shopping" href="/deus-labs/merch" cta="Discover">
    The unit for **promoting** the XMAQUINA brand in both physical and digital worlds
  </Card>
</Columns>
