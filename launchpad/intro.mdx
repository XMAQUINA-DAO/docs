...
The **Machine Launchpad** is XMAQUINA’s incubation and fundraising programme for projects at the frontier of **crypto and Physical AI**.  
...
<Columns cols={2}>
  <Card title="crypto x robotics" icon="robot" href="/launchpad/process" cta="Explore process">
