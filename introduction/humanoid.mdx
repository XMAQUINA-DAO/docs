...
**<Tooltip tip="">This is where XMAQUINA positions itself: investing early in private robotics companies and the wider ecosystem of technologies, infrastructure, and applications that will define the humanoid era.</Tooltip>**