...
description: "Multi-entity legal framework connecting onchain governance with compliant off-chain execution through MachineDAO LLC."
---

XMAQUINA operates through a structured multi-entity framework designed to connect onchain governance with compliant offchain asset execution.
...
MachineDAO LLC serves as the governance and treasury entity of the ecosystem. It is governed through onchain DEUS token voting mechanisms and retains authority over capital deployment decisions.
